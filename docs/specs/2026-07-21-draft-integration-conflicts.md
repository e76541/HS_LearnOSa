...
**2026-07-22 改掛提案 → 2026-07-23 已裁**:產品主敘述＝「文本 → 模塊(拆／選) → 牌組(固定) → 九宮｜牌組(隨機)」,見 [管線整合](2026-07-22-pipeline-deck-nine-grid-integration.md)(原待裁 1/2 均裁定採用)。上表九宮獨占中段的敘述降為舊試行參照。六衝突不因改掛自動解消。
