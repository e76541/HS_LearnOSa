...
| [specs/2026-07-27-usage-first-learning-loop.md](specs/2026-07-27-usage-first-learning-loop.md) | 草稿 | 無 | [流程圖](specs/assets/2026-07-27-usage-first-loop.html) | **使用優先學習迴路**：六步＋使用卡；**§2.1 規則深度三層**；**§2.2 疑問旁路**（你問－Agent 短答→qna→額外題回灌 F3c；無硬上限；practice-ready／pending_module）；**§2.3 一篇一夾＋Obsidian 友善 md**；前台／後台／索引底層；§6 三類分流；§7 待裁 a–c／e（d 已裁）；未裁不生效，可先試作 |
